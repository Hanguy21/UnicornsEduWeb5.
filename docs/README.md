...
- Route `/staff` hiện có staff shell với sidebar theo role:
  ...
  - thông báo: **chuông** trên sidebar staff (panel + URL `/staff/notification` cho trang feed đầy đủ); không còn mục menu riêng. Khi online, toast Sonner realtime qua websocket `/notifications`
