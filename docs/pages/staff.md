...
- `/staff/classes/[id]`
  - tab **Nội dung** dùng chung `ClassContentManager` với admin: nút **Thêm chuyên đề** mặc định tab **Thêm từ khoá** (cây Chủ đề → Chuyên đề) khi khoá còn topic; fallback **Tạo mới cho lớp** nếu khoá trống.
