...
- `/staff/classes/[id]`
  ...
  - bảng lịch sử buổi học dùng `SessionHistoryTable` `variant="classDetail"` (ẩn list, mở từ dòng timeline); hiển thị `trạng thái thanh toán` chỉ đọc; preview trợ cấp read-only khi sửa buổi
